...
export default class RobotItem extends React.Component { 
  ...
  render() {
    ...
    /* Render images */
    var showDots = false;
    //alert(this.recordContent.first_image_url)
    if(this.recordContent.first_image_url != null){
      singleImg = this.recordContent.first_image_url;
    }else if(this.recordContent.image_urls !== undefined){
      singleImg = this.recordContent.image_urls[0];
    }
