...
//https://api-dev.superble.com/api/v1/products/1732/questions
	...
	fetchRelatedArticles=(productId)=>{
		fetch("https://api-staging.superble.com/api/v1/products/"+productId+"/related_articles",{
			method:'GET'
		})
		.then((ress)=>ress.json())
		.then(resDataa =>{
    ...
    likeComment = (value) =>{
  	...
  	saveComment = () => {
	      ...
	      fetch("https://api-staging.superble.com/api/v1/products/"+productId+"/questions/comment", {
	          method: 'POST',
	          headers: {
				  'Authorization': 'Token token='+token+';device_id=Y2QzZjJjNjU5N2YxNzM=',
								...
								<Card style={{width:'95%', marginTop: 20}}>
									...
									>
										<Left>
											...
											<Text style={{fontSize:13, borderBottomWidth:2, borderBottomColor:'#C7C9C8',paddingLeft:20, fontWeight:'400',alignItems: 'center'}}>ONLY {record.product.points} {'\n'} POINTS !!!</Text>
										<Right>		
